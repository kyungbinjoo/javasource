...
public class MyShop implements IShop {
	...
	public void genProduct() {
		...
		products [2] = new CellPhone("아이폰11",800000,"LGU+");
		products [3] = new SmartTV("삼성울트라hd",25000,"4K");
		products [4] = new SmartTV("lg스마트",150000,"1080p");
...
//		}
		...
		public void productList() {
			...
			switch(input){
				case "0" : case "1" : case "2" : case "3" : case "4" ://0~4 상품 (장바구니에 담고 다시한번 상품 목록 보여주기)
