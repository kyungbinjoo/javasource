...
public class SubscriberInfoEx2 {
	...
	public static void main(String[] args) {
		...
		//기본타입(byte,short,.....)의 초기화는 null을 줄 수 없음.
//		int a = null;
//		String str = null;
//		TV tv = null;
		...
		info[1] = new SubscriberInfo("성춘향", "sung123","sung1234*", "010-1234-1234","경기도 남양주시");
		info[2] = new SubscriberInfo("송중기", "12344321s", "12344321*","010-4566-1234", null);
