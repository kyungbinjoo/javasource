...
public class CalculatorEx3 {
	...
	public static void main(String[] args) {
		...
		//클래스 메소드 호출
		System.out.println("c + d=" +Calculator3.add(10, 5));
		System.out.println("c - d=" +Calculator3.subtract(10, 5));
		System.out.println("c * d=" +Calculator3.multiply(10, 5));
		System.out.println("c / d=" +Calculator3.divide(10, 5));
	}
